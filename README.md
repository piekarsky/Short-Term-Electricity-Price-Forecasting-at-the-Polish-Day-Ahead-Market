...
binary dummy coding was used (the dummy variable 1 was set for the period between 6 a.m. and 9 p.m., where it is visible
are higher electricity prices, otherwise 0)
